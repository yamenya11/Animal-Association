            ...
            //////////////////
                    ...
                    public function courses()
                {
                    return $this->belongsToMany(Course::class, 'course_user')
                        ...
                        public function getTotalCourseLikesAttribute()
                {
                    return $this->courses()->wherePivot('is_liked', true)->count();
                }

                public function getTotalCourseViewsAttribute()
                {
                    return $this->courses()->sum('pivot_video_views');
                }
